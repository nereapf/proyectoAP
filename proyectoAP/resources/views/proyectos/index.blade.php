<x-layouts.layout>
    ...
    <div class="w-full bg-azulBordes py-4 px-8 flex justify-between items-center shadow">
        <h1 class="text-2xl font-bold text-blue-900 tracking-wide">GESTIÓN DE PROYECTOS</h1>
                    ...
                    @foreach($filas as $fila)
                        <div class="bg-white rounded-xl shadow-lg mb-6 p-6">
                            <div class="border-b border-gray-200 pb-4 mb-4">
                                <h2 class="text-xl font-bold text-azulOscuro">{{ $fila->nombre }}</h2>
                            ...
                            <div class="mt-6 flex gap-2 border-t pt-4">
                                <a href="{{ route('proyectos.edit', $fila) }}"
                                   class="bg-azulBordes text-white px-4 py-2 rounded hover:bg-azulOscuro transition">
                                    Editar
                                </a>
