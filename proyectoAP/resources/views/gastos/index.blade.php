<x-layouts.layout>
    ...
    <div class="w-full bg-azulBordes py-4 px-8 flex justify-between items-center shadow">
        <h1 class="text-2xl font-bold text-blue-900 tracking-wide">GESTIÓN GASTOS DE FABRICACIÓN</h1>
                        ...
                        <ul>
                            @forelse($filas as $fila)
                                <li class="flex items-center justify-between py-2 border-b border-gray-200 last:border-b-0">
                                    <span class="font-medium text-gray-800">{{ $fila->nombre }}</span>
                                    <div class="flex gap-4">
                                        <span class="text-gray-700">{{ number_format($fila->precio_hora, 2) }} €/hora</span>
